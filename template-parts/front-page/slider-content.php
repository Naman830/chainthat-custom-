...
$product_category      = get_categories();
	...
	<div class="product mb-5">
		...
		<div class="product-info">
			...
			<h6 class="product-price text-gray-800 font-semibold mr-3 mb-5">
				<div class="row">
					<div class="col">
						<span class="product-price mr-2"><?php echo wp_kses_post($regular_price); ?>
					</div>
					<div class="col d-flex justify-content-end">
						<?php if ($sale_price) { ?>
							<p>>Special Price: <span class="product-price mr-2"> <?php echo wp_kses_post($sale_price); ?></p>
						<?php } ?>
					</div>
				</div>
